...
const DaVinci = () => {
  ...
  return (
    <>
      <NextSeo
        title="Da Vinci | Publishing Package"
        description=""
        canonical={
          (
      ...
      <PageBanner pageTitle="Da Vinci Publishing Package" />
        ...
        <div className="container">
          <div className="row justify-content-center align-items-center">
            <div className="col-lg-12 col-md-12 services-content">
              ...
              <p style={{ marginTop: "1rem" }}>
                Heighten the imaginations of young toddles with more
                illustrations that reflect the scenarios of the real world. Our
                Da Vinci package offers an ideal option to bring your board book
                plans to life. See the full package inclusions below:
              </p>
              ...
              <Container>
                <Row>
                  ...
                  <Col sm={6} md={6} lg={6}>
                    ...
                    <ul>
                      <li>
                        <h6>95 Copies (shipping and handling applies)</h6>
                      </li>
                    </ul>
                  </Col>
                  ...
                  <Col sm={6} md={6} lg={6}>
                    ...
                    <ul>
                      <li>
                        <h6>
                          Minimum of 8 pages (4 spreads); Maximum of 20 pages
                          (10 spreads)
                        </h6>
                      </li>
                      <li>
