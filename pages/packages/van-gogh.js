...
const VanGogh = () => {
  ...
  return (
    <>
      <NextSeo
        title="Van Gogh | Publishing Package"
        description=""
        canonical={
          (
      ...
      <PageBanner pageTitle="Van Gogh Publishing Package" />
        ...
        <div className="container">
          <div className="row justify-content-center align-items-center">
            <div className="col-lg-12 col-md-12 services-content">
              ...
              <p style={{ marginTop: "1rem" }}>
                Our Van Gogh package provides a complete set of services for
                your board book, from design to basic marketing. Plus, take
                advantage of our Advance Website Design that is exclusive only
                for this package. See the full package inclusions below:
              </p>
              ...
              <Container>
                <Row>
                  ...
                  <Col sm={6} md={6} lg={6}>
                    ...
                    <ul>
                      <li>
                        <h6>90 Copies (shipping and handling applies)</h6>
                      </li>
                    </ul>
                  </Col>
                  ...
                  <Col sm={6} md={6} lg={6}>
                    ...
                    <ul>
                      <li>
                        <h6>
                          Minimum of 8 pages (4 spreads); Maximum of 30 pages
                          (15 spreads)
                        </h6>
                      </li>
                      <li>
