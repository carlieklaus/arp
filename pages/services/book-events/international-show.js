...
const BookExhibitInternational = () => {
  ...
  return (
    <>
      <Head>
        <title>Book Exhibit - International Show | Services </title>
      </Head>
      <Navbar />
              ...
              <div className="col-lg-12 col-md-12 services-content">
                <div className="section-title">
                  <div className="services-title-back ">
                    <h2>Book Exhibit - International Show</h2>
                    <Button
                ...
                <div style={{ marginTop: "2rem" }}>
                  ...
                  <ul>
                    ...
                    <li>
                      <h6>Press Release Campaign Essential 500 outlets</h6>
                    </li>
                  </ul>
                </div>
...
export default BookExhibitInternational;
